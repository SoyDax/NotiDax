        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" >
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">AÑADIR CATEGORIAS</h1>
                    <p class="mb-4">Aqui puede añadir las categorias de las noticias
                          </p>
                            ...
                            <tr>
                                <th>
                                        ...
                                        <a href="manage-categories.php" class="btn btn-primary btn-icon-split" >
                                            ...
                                            <span class="text">Regresar a Categorias</span>
                                        </a>
...
<input type="text" class="form-control" value="<?php echo htmlentities($row['CategoryName']);?>" name="category"  placeholder="Escribe el nombre de la categoria" required>
</div>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Descripcion de la Categoria:</b></h4>
