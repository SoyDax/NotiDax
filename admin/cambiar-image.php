...
{
echo "<script>alert('Formato invalido. solo jpg / jpeg/ png /gif formato');</script>";
}
else
{
...
if($query)
{
$msg="Imagen de la noticia actualizada! ";
}
else{
$error="Sucedio un error . Intenta otra vez.";    
} 
}
}
?>
...
?>
                    ...
                    <div class="card shadow mb-2">
                        <div class="card-header py-3">
                            ...
                            <tr>
                                <th>
                                        <a href="javascript:history.back()" class="btn btn-success btn-icon-split" >
                                            <span class="icon text-white-50">
                                            <i class="fa-solid fa-arrow-right"></i>
                                            </span>
                                            <span class="text">Regresar a editar</span>
                                        </a>
...
<h5 class="card-title">Nueva imagen:</h5>
