...
if (strlen($_SESSION['usuario']) != true) {
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Sub
                                                    categorias añadidas
                                                </div>
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col-auto">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    ...
                                                    ?>
                                                    <h2>
                                                        <?php echo htmlentities($countcomments); ?> <small></small>
                                                    </h2>
                                                </div>
                                            </div>
                                            <div class="col-auto">
                            ...
                            <div class="col-xl-12 col-lg-7">
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Las noticias del dia</h6>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <p>Agrega las noticias mas interesantes del momento, podras personalizar la
                                            descripcion de la noticia segun como llame mas la atencion.
                                            Ademas agregar una portada que llame al publico a leerlo.
                                        </p>
                                        <a target="_blank" rel="nofollow" href="add-post.php">Agrega las noticias aqui
                                            &rarr;</a>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Seguro queiere salir?</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">Seleccione "Salir" para poder cerrar sesion.</div>
