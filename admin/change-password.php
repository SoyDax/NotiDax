            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item" href="change-password.php?pid=<?php echo $_SESSION['idUsuario']; ?>?pid=<?php echo htmlentities($row['idUsuario']); ?>"> 
                    ...
                    <?php if ($_SESSION['rol'] == 1) { ?>
                        ...
                        <h1 class="h3 mb-2 text-gray-800">Cambia tu contraseña aqui</h1>
                        <p class="mb-4">para mas seguridad cambia contraseña
                        </p>
                        <?php } ?>
                        <div class="col-sm-6">
                            <!---Success Message--->
                    ...
                    $query = mysqli_query($con, "SELECT idUsuario, userName, password, rol FROM usuarios WHERE idUsuario = $postid AND Is_Active = 1");
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <?php if ($_SESSION['rol'] == 1) { ?>
                                                ...
                                                <?php } ?>
                                                <?php if ($_SESSION['rol'] == 0) { ?>
                                                <a href="dashbord.php" class="btn btn-secondary btn-icon-split">
                                                    <span class="icon text-white-50">
                                                        <i class="fas fa-arrow-right"></i>
                                                    </span>
